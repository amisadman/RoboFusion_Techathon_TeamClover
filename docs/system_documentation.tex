...
\begin{tabular}{l l l}
\toprule
\textbf{Name} & \textbf{University} & \textbf{GitHub / Portfolio} \\
\midrule
Sadman Islam & Metropolitan University & \href{https://github.com/amisadman}{GitHub: amisadman} \\
Shah Samin Yasar & Metropolitan University & \href{https://shahsaminyasar.vercel.app/}{Portfolio: shahsaminyasar} \\
Ahmed Thousif Thisham & Metropolitan University & \href{https://ahmedthousifportfolio.vercel.app/}{Portfolio: ahmedthousif} \\
\bottomrule
\end{tabular}\\
\vspace{0.3cm}\\
\small \textbf{GitHub Repository:} \href{https://github.com/amisadman/RoboFusion_Techathon_TeamClover}{https://github.com/amisadman/RoboFusion\_Techathon\_TeamClover}\\
\small \textbf{Live Web Dashboard:} \href{https://clover-scs-rg.vercel.app/}{https://clover-scs-rg.vercel.app/}\\
\small \textbf{Production Live API Base:} \href{https://robofusion-techathon-teamclover.onrender.com}{https://robofusion-techathon-teamclover.onrender.com}}

\date{\today}

\begin{document}

% --- PAGE 1: TITLE, TEAM INFO, GITHUB REPO, ABSTRACT ---
\maketitle
\thispagestyle{empty}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{db_schema.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{iot_lab.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{server_room.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{data_science_lab.png}
