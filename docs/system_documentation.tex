...
\title{\textbf{\Large System Documentation: Smart Campus Safety \& Risk Grid (SCS-RG)}\\
\vspace{0.2cm}
\Large End-to-End System Specifications, Hardware Circuits, Software Architecture, API Reference, and Risk Fusion Engine}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{../readme_resources/db_schema.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{../readme_resources/iot_lab.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{../readme_resources/server_room.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{../readme_resources/data_science_lab.png}
...
\midrule
Fire ($w_{\text{fire}}$) & 40.0 & \textbf{Critical Life Safety Threat}: Thermal combustion spreads rapidly and presents immediate catastrophic risk to life and physical assets. Demands top weighting. \\
Gas ($w_{\text{gas}}$) & 40.0 & \textbf{Explosion Risk}: Combustible gas accumulation (MQ2) creates severe explosion hazards in confined lab spaces. Equal priority to fire. \\
...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{../readme_resources/db_schema.png}
...
\section{System Setup \& Verification Summary}
...
\subsection{Verification Matrix (Rubric Test Cases 26--30)}
\begin{table}[H]
\centering
\begin{tabularx}{\textwidth}{c X c}
\toprule
\textbf{Test Case} & \textbf{Requirement Metric} & \textbf{Status} \\
\midrule
TC26 & Circuit diagrams per zone (IoT Lab, Server Room, Data Science Lab) & PASS \\
TC27 & Full System Component Architecture Diagram & PASS \\
TC28 & Complete API Documentation with Example Request/Response JSON & PASS \\
TC29 & Database ER Diagram & PASS \\
TC30 & Bounded Risk Fusion Formula with Weight Justification & PASS \\
\bottomrule
\end{tabularx}
\caption{System Documentation Verification Summary}
\end{table}
